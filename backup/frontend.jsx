    ...
    <Seo>
      <main>
        <section className="projects-page">
          <Projects title="frontend projects" projects={projects} />
        </section>
      </main>
    </Seo>
  );
...
export const Head = () => <Seo title={"Frontend Projects"} />;

export const query = graphql`
  query allProjectByGrade {
    allContentfulPortfolioProjects(filter: { grade: { eq: "frontend" } }) {
      totalCount
      nodes {
        id
        title
